TEXTS = {
    "START": "🇺🇿 Assalamu Alaykum <b>«Forward Academy»</b> o'quv markaziga xush kelibsiz.\n\n"
             "🇷🇺 Здравствуйте добро пожаловать в учебный центр <b>«Forward Academy»</b>.\n\n"
             "🇬🇧 Hello, welcome to the <b>«Forward Academy»</b> educational center.",
